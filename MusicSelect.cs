    ...
    public void GameStart(AudioClip MusicSelected)
    {
        switch(dataCenter.Musics[currentPoint].key)
        {
            ...
            case 20:
                ...
                break;
            case 21:
                dataCenter.push_.getNote(dataCenter.Musics[currentPoint].list[currentDifficulty]);
                break;
            case 22:
            ...
            case 23:
                ...
                break;
            case 24:
                dataCenter.fly_Away.getNote(dataCenter.Musics[currentPoint].list[currentDifficulty]);
                break;
            case 25:
            ...
            case 29:
                ...
                break;
            case 30:
                dataCenter.someday.getNote(dataCenter.Musics[currentPoint].list[currentDifficulty]);
                break;
            case 31:
                dataCenter.remember.getNote(dataCenter.Musics[currentPoint].list[currentDifficulty]);
                break;
            case 32:
